...
HRET CMinerServer::getBlockTemplate() throw (HCException) {
	...
	LOG_NORMAL("return control: {type: [%d], nid: [%d], bid: [%d], len: [%d], rtype: [%d]}", control.GetType(), control.GetNid(), control.GetBid(), control.GetLen(), control.GetRType());
