...
HRET CMqObj::Init() throw (HCException) {
    HFUN_BEGIN;
...
HRET CMqObj::initMq() throw (HCException) {
    HFUN_BEGIN;
...
HRET CMqObj::sendAndRecv(HCSTRR strCmd, HSTRR str) throw (HCException) {
    HFUN_BEGIN;
