...
/* ./.libs/lt-libconfig_tests.c - temporary wrapper executable for .libs/libconfig_tests
...
const char * LIB_PATH_VALUE   = "/cygdrive/e/libs/libconfig-1.4.10/lib/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/e/libs/libconfig-1.4.10/tinytest:/cygdrive/e/libs/libconfig-1.4.10/lib/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "libconfig_tests"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# libconfig_tests - temporary wrapper script for .libs/libconfig_tests\n", f);
  ...
  fputs ("  notinst_deplibs=' /cygdrive/e/libs/libconfig-1.4.10/lib/.libs/libconfig.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"libconfig_tests:libconfig_tests:${LINENO}: libtool wrapper (GNU libto", f);
  fputs ("ol) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"libconfig_tests:libconfig_tests:${LINENO}: newargv[$lt_dump_args_N]:", f);
  fputs (" $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"libconfig_tests:libconfig_tests:${LINENO}: newargv[0]: $progdir/", f);
  fputs ("$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/e/libs/libconfig-1.4.10/tinytest:/cygdrive/e/libs/libconfig-", f);
  fputs ("1.4.10/lib/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/e/libs/libconfig-1.4.10/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
