...
/* ./.libs/lt-example3.c - temporary wrapper executable for .libs/example3
...
const char * TARGET_PROGRAM_NAME = "example3"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# example3 - temporary wrapper script for .libs/example3\n", f);
  ...
  fputs ("    echo \"example3:example3:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"example3:example3:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"example3:example3:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
