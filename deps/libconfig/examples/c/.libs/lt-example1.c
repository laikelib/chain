...
/* ./.libs/lt-example1.c - temporary wrapper executable for .libs/example1
...
const char * EXE_PATH_VALUE   = "/cygdrive/e/libs/libconfig-1.4.10/lib/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "example1"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# example1 - temporary wrapper script for .libs/example1\n", f);
  ...
  fputs ("    echo \"example1:example1:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"example1:example1:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"example1:example1:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/e/libs/libconfig-1.4.10/lib/.libs:/usr/local/lib:/usr/local/", f);
  fputs ("bin:$PATH\n", f);
  fputs ("\n", f);
