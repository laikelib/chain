 ...
 *
 * Create Date: Wed Nov 01 12:19 2017
 *
 * Description:
 *	
 *
...
public:
    ...
    */
	...
	//HASSERT_THROW_MSG(BN_exp(&res, this, &e, pctx), "CBigNum::pow : BN_exp failed", LOGIC_ERR);
	...
	//HASSERT_THROW_MSG(BN_mod_mul(&res, this, &b, &m, pctx), "CBigNum::pow : BN_exp failed", LOGIC_ERR);
	...
	//HASSERT_THROW_MSG(BN_mod_exp(&ret, &inv, &posE, &m, pctx), "CBigNum::pow_mod: BN_mod_exp failed on negative exponent", LOGIC_ERR);

	//  HASSERT_THROW_MSG(BN_mod_exp(&ret, this, &e, &m, pctx), "CBigNum::pow_mod : BN_mod_exp failed", LOGIC_ERR);
        return ret;
    }
    ...
    */
	...
	HASSERT_THROW_MSG(BN_mod_inverse(&ret, this, &m, pctx), "CBigNum::inverse*= :BN_mod_inverse", LOGIC_ERR);
	/*
	...
	*/
	...
	HASSERT_THROW_MSG(BN_generate_prime_ex(&ret, numBits, (safe == true), NULL, NULL, NULL), "CBigNum::generatePrime*= :Bn_generate_prime_ex", LOGIC_ERR);
	/*
	...
	*/
	...
	HASSERT_THROW_MSG(BN_gcd(&ret, this, &b, pctx), "CBigNum::gcd*= :BN_gcd", LOGIC_ERR);
	/*
